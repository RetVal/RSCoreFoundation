...
RSExport volatile RSSpinLock  __RSRuntimeClassTableSpinLock;
...
RSExport void      RSCoreFoundationInitialize() __RS_INIT_ROUTINE(RSRuntimePriority);//__RS_INIT_ROUTINE(RSRuntimePriority);
enum {
...
void __HALT() __attribute__((noreturn));
