...
RSExport RSTypeID RSTimeZoneGetTypeID() RS_AVAILABLE(0_0);
RSExport RSArrayRef RSTimeZoneCopyKnownNames() RS_AVAILABLE(0_0);

RSExport RSTimeZoneRef RSTimeZoneCopySystem() RS_AVAILABLE(0_0);    // copy system timezone, autoreleased.
RSExport RSTimeZoneRef RSTimeZoneCopyDefault() RS_AVAILABLE(0_0);
