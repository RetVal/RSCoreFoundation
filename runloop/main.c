...
{
    RSURLConnectionSendAsynchronousRequest(RSURLRequestWithURL(RSURLWithString(RSSTR("http://123.321.fuck"))), nil, ^(RSURLResponseRef response, RSDataRef data, RSErrorRef error) {
        RSShow(response);
        RSShow(data);
        RSShow(error);
