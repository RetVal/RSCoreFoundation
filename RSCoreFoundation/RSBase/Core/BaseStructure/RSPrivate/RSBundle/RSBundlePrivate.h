...
RSPrivate void _RSBundleInitMainBundle(void);
RSPrivate void _RSBundleFinalMainBundle(void);
RSPrivate void __RSBundleGLock(void);
RSPrivate void __RSBundleGUnlock(void);
...
RSPrivate RSBundleRef _RSMainBundle(void);
