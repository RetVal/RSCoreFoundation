...
{
    __RSGenericValidInstance(connection, _RSConnectionTypeID);
    if (connection->socket4FD != SOCKET_NULL) return RSConnectionGetConnectedHostFromSocket4(connection->socket4FD) ? 1 : 0;
    return 0;
}
...
{
    __RSGenericValidInstance(connection, _RSConnectionTypeID);
    if (connection->socket6FD != SOCKET_NULL) return RSConnectionGetConnectedHostFromSocket6(connection->socket6FD) ? 1 : 0;
    return 0;
}
