...
static void __RSArchiverInitialize_Allocator(void);
static void __RSArchiverInitialize_Array(void);
static void __RSArchiverInitialize_Calendar(void);
static void __RSArchiverInitialize_Data(void);
static void __RSArchiverInitialize_Date(void);
static void __RSArchiverInitialize_Dictionary(void);
static void __RSArchiverInitialize_Error(void);
static void __RSArchiverInitialize_Exception(void);
static void __RSArchiverInitialize_Nil(void);
static void __RSArchiverInitialize_Notification(void);
static void __RSArchiverInitialize_Number(void);
static void __RSArchiverInitialize_Plist(void);
static void __RSArchiverInitialize_Queue(void);
static void __RSArchiverInitialize_Set(void);
static void __RSArchiverInitialize_String(void);
static void __RSArchiverInitialize_Timezone(void);
static void __RSArchiverInitialize_UUID(void);
