...
RSExport RSTypeID RSHTTPCookieStorageGetTypeID(void) RS_AVAILABLE(0_4);

RSExport RSHTTPCookieStorageRef RSHTTPCookieStorageGetSharedStorage(void) RS_AVAILABLE(0_4);
