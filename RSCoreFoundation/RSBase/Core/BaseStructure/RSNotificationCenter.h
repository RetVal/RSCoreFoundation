...
RSExport RSTypeID RSNotificationCenterGetTypeID(void) RS_AVAILABLE(0_1);
RSExport RSNotificationCenterRef RSNotificationCenterGetDefault(void) RS_AVAILABLE(0_1);
