...
RSExport RSTypeID RSDistributedNotificationCenterGetTypeID(void) RS_AVAILABLE(0_3);
RSExport RSDistributedNotificationCenterRef RSDistributedNotificationCenterGetDefault(void) RS_AVAILABLE(0_3);
RS_EXTERN_C_END
#endif
