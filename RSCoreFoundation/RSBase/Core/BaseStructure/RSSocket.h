...
RSExport RSStringRef RSSocketGetLocalIp(void) RS_AVAILABLE_BUT_DEPRECATED(0_0, 0_4);
RSExport RSStringRef RSSocketGetLocalName(void) RS_AVAILABLE_BUT_DEPRECATED(0_0, 0_4);

RSExport RSTypeID RSSocketGetTypeID(void) RS_AVAILABLE(0_0);
