...
RSExport void RSPerformBlockInBackGround(void (^perform)(void)) RS_AVAILABLE(0_3);
RSExport void RSPerformBlockOnMainThread(void (^perform)(void)) RS_AVAILABLE(0_3);
RSExport void RSPerformBlockInBackGroundWaitUntilDone(void (^perform)(void)) RS_AVAILABLE(0_3);
RSExport void RSPerformBlockOnMainThreadWaitUntilDone(void (^perform)(void)) RS_AVAILABLE(0_3);
RSExport void RSPerformBlockAfterDelay(RSTimeInterval delayTime, void (^perform)(void)) RS_AVAILABLE(0_3);
...
#endif
RSExport void RSRunLoopRun(void) RS_AVAILABLE(0_0);   // start the current RSRunLoop, it will block until its work finished.
...
RSExport RSTypeID RSRunLoopSourceGetTypeID(void) RS_AVAILABLE(0_0);
...
RSExport RSTypeID RSRunLoopGetTypeID(void) RS_AVAILABLE(0_0);

RSExport RSRunLoopRef RSRunLoopGetCurrent(void) RS_AVAILABLE(0_0);   // get the RSRunLoop for the current thread with retain
RSExport RSRunLoopRef RSRunLoopGetMain(void) RS_AVAILABLE(0_0);      // get the RSRunLoop for the main thread with retain
